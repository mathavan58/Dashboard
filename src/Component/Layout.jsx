...
const Layout = () => {
  ...
  const isTaskActive = location.pathname === '/task' || location.pathname === '/taskstatus';
  ...
  <NavLink to="/task" className={isTaskActive ? 'Layout-link active' : 'Layout-link'} ><MdOutlineChromeReaderMode className='svg-link'/></NavLink>
