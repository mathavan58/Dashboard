...
const TaskStatus = () => {
  ...
  return (
    <div className="Task p-4 m-0 w-100" id='task-status'>
      <div className="row g-2 d-flex align-items-center text-white rounded-4 p-1 pb-2" id="Task-head">
  ...
  <label className="form-check-label" htmlFor="switchCheckDefault">Status</label>
      ...
      <div className="row row-cols-5 g-2 pt-5" id='task-rows-align'>
